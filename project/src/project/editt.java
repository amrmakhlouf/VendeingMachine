...
public class editt {
    ...
    public static JTextField  jBACK  , jfname,jlname,jusername,jpassword , jdate , jmobile, jemail ,jnumroom;
    public JPanel panel ; 
    public Icon reg ; 
    public Font tr;
    ...
    public editt() throws FileNotFoundException, IOException {
        
       
        
             tr = new Font("serif", Font.BOLD+Font.ITALIC, 18);
        back = new ImageIcon("img/ENG.jpg");
  ...
  bleft = new JButton(left);
    ...
    AD = new JButton("Edit Profile");
    AD.setBackground(new Color(0,0,200,200));
    AD.setFont(tr);
    AD.setForeground(new Color(255,255,255));
    
        reg = new ImageIcon ("img/zu.png");
        REG = new JLabel(reg);
        ...
        jusername = new JTextField();
         jnumroom = new JTextField();
                    ...
                    jusername.setText(office101.un);
                    jfname.setText(office101.fn);
                    jlname.setText(office101.ln);
                    jemail.setText(office101.em);
                    jmobile.setText(office101.mo);
                    jdate.setText(office101.da);
                    jnumroom.setText(office101.ro);
                    jpassword.setText(office101.pa);
                    jusername.disable();
